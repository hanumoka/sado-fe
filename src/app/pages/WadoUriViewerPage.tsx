 ...
 *
 * dicom-viewer의 DicomViewerPage와 완전 독립적인 구현
...
export default function WadoUriViewerPage() {
  ...
  const [layout, setLayout] = useState<WadoUriGridLayout>('1x1')
  ...
  const handleLayoutChange = (newLayout: WadoUriGridLayout) => {
    setLayout(newLayout)
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-lg font-bold">
              ...
              <span className="ml-2 text-yellow-400 text-sm font-normal">(WADO-URI POC)</span>
            </h1>
              ...
              {Array.from({ length: currentLayoutSlots }, (_, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <WadoUriSlot
                      slotId={i}
                      renderingEngineId={WADO_URI_RENDERING_ENGINE_ID}
                    />

                    {/* 선택된 슬롯 표시 */}
                    {isSelected && (
                      <div className="absolute top-2 right-2 bg-yellow-500 px-2 py-0.5 rounded text-xs text-white z-10">
                        선택됨
                      </div>
                    )}
                  </div>
                ...
                {filteredInstances.map((instance, index) => {
                  ...
                  return (
                    <div
                      ...
                      className="aspect-square bg-gray-700 rounded overflow-hidden cursor-pointer hover:ring-2 hover:ring-yellow-500 transition-all relative"
                    ...
                    >
                      ...
                      {/* 멀티프레임 배지 */}
                      {isMultiframe && (
                        <div className="absolute bottom-1 right-1 bg-yellow-600/80 px-1.5 py-0.5 rounded text-xs text-white">
